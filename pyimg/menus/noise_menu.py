...
class NoiseImageMenu:
    ...
    def __init__(self, menubar, image_io):
        ...
        noise_menu.add_command(label="Gaussian",
                               command=NoiseOperation(image_io, 'Apply Gaussian Noise',
        ...
        noise_menu.add_command(label="Rayleigh",
                               command=NoiseOperation(image_io, 'Apply Rayleigh Noise',
                                                      lambda image, **kwargs: noise_image_wrapper(
        ...
        noise_menu.add_command(label="Exponential",
                               command=NoiseOperation(image_io, 'Apply Exponential Noise',
                                                      lambda image, **kwargs: noise_image_wrapper(
